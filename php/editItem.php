...
foreach (array_keys($_POST) as $key)
{
    ...
    if(empty($_POST[$key])&&$key!="img")
    {
      echo '<script type="text/javascript">alert("'.$key.'"); window.location.assign("../editItem.html?sno='.$sno.'"); </script>';
      exit;
    }
}
    ...
    //  echo "".$stmt;
      ...
      //echo $nextSnoValue["AUTO_INCREMENT"];
        ...
        $delete = "delete from `".$username."_".$category."` where sno = ".$_POST['sno']; //method used here is adding the new item and then deleting the old one. Here it is deleting in this line.
